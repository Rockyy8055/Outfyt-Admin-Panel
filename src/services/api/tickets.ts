...
import type { Ticket, PaginatedResponse, PaginationParams, TicketFilters, TicketMessage } from '@/types';
...
export const ticketsApi = {
  ...
  reply: async (id: string, message: string, isInternal: boolean = false): Promise<TicketMessage> => {
